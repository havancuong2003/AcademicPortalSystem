select distinct g.id as gid,mc.id as mcid, g.courseId,mc.gradeCategory,mc.gradeItem,mc.[weight] from   mark_course mc join mark_student ms on ms.mark_course_id=mc.id
