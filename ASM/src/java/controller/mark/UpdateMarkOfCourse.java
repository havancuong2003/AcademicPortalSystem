 ...
 * @author -MSI-
 */
public class UpdateMarkOfCourse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateMarkOfCourse</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateMarkOfCourse at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("test11", groupid);
        request.setAttribute("test21", gradeItem);
        ...
        for (Mark mark : insertMarkForCourse) {
           ...
           mdbc.updateMarkOfStudent(value, Integer.parseInt(groupid), gradeItem, mark.getStudent().getId());
        }
