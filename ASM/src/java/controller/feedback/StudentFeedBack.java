...
public class StudentFeedBack extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        FeedBack f = fbdbc.getFeedBackByID(id, a.getUsername());
        request.setAttribute("feedback", f);
        request.setAttribute("fid", id);

        request.getRequestDispatcher("../view/feedback/student.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        fbdbc.updateFeedBack(fid, content);
