...
public class ChatController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (role == 3) {
            ArrayList<String> listGroupForStudent = gdbc.getListGroupForStudent(a.getUsername());
            request.setAttribute("studentGroups", listGroupForStudent);
        } else {
            ArrayList<String> listGroupForLecture = gdbc.getListGroupForLecture(a.getUsername());
