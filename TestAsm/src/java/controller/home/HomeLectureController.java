...
public class HomeLectureController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (stinfo == null) {
            ...
            request.setAttribute("list", sdbc.getStudentForSerach(stinfo));
            if(sdbc.getStudentForSerach(stinfo).isEmpty()){
                request.setAttribute("notFound", "can not found student with info like "+stinfo);
            }
        }
